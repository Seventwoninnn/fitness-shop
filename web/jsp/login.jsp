...
<div class="login">
    <form action="${pageContext.request.contextPath}/UserServlet?action=login" method="post">
        ...
        <p><input type="text" name="user_Password" placeholder="密码"></p>
        <p>
            <input type="text" name="verifyCodes" placeholder="验证码" style="width: 100px;">
        ...
        <p class="txt"><a class="" href="/jsp/regesite.jsp">免费注册</a></p>
    </form>
</div>
</body>
