...
<div class="head">
    ...
    <div class="banner"><a href="#"><img src="${pageContext.request.contextPath}/img/banner3.png"/></a></div>
    <div class="address">
        <div class="wrapper clearfix"><a href="${pageContext.request.contextPath}/jsp/IndexServlet?action=base">首页</a><span>/</span>
            <c:if test="${catef.cateName!=null}">
