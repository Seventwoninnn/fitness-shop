...
<div class="container">
    ...
    <h2 class="text-center">分类增加</h2>
    <form id="categoryAddForm" class="form-horizontal" action="jsp/admin/CategoryManageServlet?action=add2"
          method="post">

		<div class="form-group">
			<label for="cateParentId" class="col-sm-2 col-sm-offset-2 control-label">一级分类</label>
			<div class="col-sm-4 ">
		...
		<div class="form-group">
			<label for="cateName" class="col-sm-2 col-sm-offset-2 control-label">类型名称</label>
			<div class="col-sm-4 ">
