...
<h2 class="text-center">收货地址列表</h2>
<div class="container-fulid content">
    <div class="funbtn">
        <a id="batDel" class="btn btn-danger" href="javascript:void(0)">批量删除</a>
        <a class="btn btn-info" href="jsp/admin/addressManage/addressAdd.jsp">增加收货地址</a>
    </div>
    <table class="table table-striped table-hover">
        ...
        <c:choose>
            <c:when test="${!empty addressList}">
                <c:forEach items="${addressList}" var="i" varStatus="n">
                    <tr>
                        ...
                        <td class="noClick">
                            <a class="btn btn-info btn-xs" href="jsp/admin/AddressManageServlet?action=edit&id=${i.id}">修改</a>
            ...
            <c:otherwise>
                <tr>
                    <td colspan="8"><h4 class="text-center">当前无更多收货地址信息</h4></td>
                </tr>
            </c:otherwise>
        </c:choose>
    </table>
...
<script type="text/javascript">
    ...
    $("#batDel").click(function () {
        ...
        if (confirm("你确定要删除" + choices.length + "条收货地址吗？")) {
