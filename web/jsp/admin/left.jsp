...
<div class="left">
    <ul>
        ...
        <li class="list">
            <h3>商 品 管 理</h3>
            <ul>
                <li><a href="jsp/admin/CategoryManageServlet?action=list" target="rFrame">商品分类</a></li>
                <li><a href="jsp/admin/ProductManageServlet?action=list" target="rFrame">商品列表</a></li>
            </ul>
        </li>
        <li class="list">
            <h3>订 单 管 理</h3>
            <ul>
                <li><a href="jsp/admin/OrdersManageServlet?action=list" target="rFrame">订单列表</a></li>
        ...
        <li class="list">
            <h3>地 址 管 理</h3>
            <ul>
                <li><a href="jsp/admin/AddressManageServlet?action=list" target="rFrame">收货地址</a></li>
            </ul>
        </li>
