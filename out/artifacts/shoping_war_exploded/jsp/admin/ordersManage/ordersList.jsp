...
<div class="container-fulid content">
    ...
    <table class="table table-striped table-hover">
        ...
        <c:choose>
            <c:when test="${!empty ordersList}">
                <c:forEach items="${ordersList}" var="i" varStatus="n">
                    <tr>
                        ...
                        <td class="noClick">
                            <a class="btn btn-info btn-xs" href="jsp/admin/OrdersManageServlet?action=edit&id=${i.id}">修改</a>
            ...
            <c:otherwise>
                <tr>
                    <td colspan="8"><h4 class="text-center">当前无更多订单信息</h4></td>
                </tr>
            </c:otherwise>
        </c:choose>
    </table>
...
<script type="text/javascript">
    ...
    $("#batDel").click(function () {
        ...
        if (confirm("你确定要删除" + choices.length + "条订单吗？")) {
