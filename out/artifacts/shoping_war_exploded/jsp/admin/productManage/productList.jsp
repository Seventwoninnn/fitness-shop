...
<div class="container-fulid content">
    <div class="funbtn">
        ...
        <a class="btn btn-info" href="jsp/admin/ProductManageServlet?action=toadd">增加商品</a>
    </div>
            ...
            <c:when test="${!empty productList}">
                <c:forEach items="${productList}" var="i" varStatus="n">
                    <tr>
                        ...
                        <td><c:if test="${i.productStatus eq 1}">上架</c:if>
                            <c:if test="${i.productStatus eq 0}">下架</c:if>
                        </td>


                        <td class="noClick">
                            <a class="btn btn-info btn-xs" href="jsp/admin/ProductManageServlet?action=edit&id=${i.id}">修改</a>
...
<script type="text/javascript">
    ...
    $("#batDel").click(function () {
        ...
        if (confirm("你确定要删除" + choices.length + "条商品吗？")) {
