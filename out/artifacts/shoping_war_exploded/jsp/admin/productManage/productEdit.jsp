        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                ...
                <select name="productStatus" id="productStatus" class="form-control" required>
                    <option value="1" <c:if test="${ productInfo.productStatus eq '1'}">selected</c:if>>上架</option>
                    <option value="0" <c:if test="${ productInfo.productStatus eq '0'}">selected</c:if>>下架</option>
