...
<div class="block_home_slider">
    <div id="home_slider" class="flexslider">
        <ul class="slides">
            <li>
                <div class="slide"><img src="${pageContext.request.contextPath}/img/banner2.png"/></div>
            </li>
            <li>
                <div class="slide"><img src="${pageContext.request.contextPath}/img/banner1.png"/></div>
            </li>
        </ul>
    </div>
</div>
