    ...
    <h3><a href="#"><img src="../img/tx.png"/></a>
        <p class="clearfix">
            <c:if test="${sessionScope.user.nickname!=null}">
                ...
                <span class="fr" onclick="location.href='${pageContext.request.contextPath}/UserServlet?action=Logout'">[退出登录]</span>
            </c:if>
        </p>
    </h3>
    <div>
        ...
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/jsp/IndexServlet?action=address">收货地址</a></li>
        </ul>
    </div>
</div>
