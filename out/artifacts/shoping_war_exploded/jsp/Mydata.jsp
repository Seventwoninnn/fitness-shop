...
<div class="head ding">
    ...
    <div class="address mt" id="add">
        <div class="wrapper clearfix"><a href="IndexServlet?action=base" class="fl">首页</a><span>/</span><a href="javascript:void(0);" class="on">个人中心</a>
        </div>
    </div>
<div class="Bott">
        ...
        <div class="you fl">
            <div class="tx clearfix">
                <div class="fl clearfix"><a href="#" class="fl"><img src="${pageContext.request.contextPath}/img/tx.png"/></a>
                    <p class="fl"><span>${sessionScope.user.nickname}</span><a href="${pageContext.request.contextPath}/jsp/IndexServlet?action=changedata">修改个人信息></a></p></div>
