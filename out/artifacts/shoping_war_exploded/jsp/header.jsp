...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <div class="wrapper clearfix">
        <div class="clearfix" id="top"><h1 class="fl"><a href="${pageContext.request.contextPath}/jsp/IndexServlet?action=base"><img style="height: 80px; width: 110px" src="${pageContext.request.contextPath}/img/logo.png"/></a></h1>
            <div class="fr clearfix" id="top1"><p class="fl">
                <c:if test="${sessionScope.user.username==null}">
                    <a href="${pageContext.request.contextPath}/jsp/login.jsp" id="login">登录</a><a href="${pageContext.request.contextPath}/jsp/regesite.jsp" id="reg">注册</a>
                </c:if>
                <c:if test="${sessionScope.user.username!=null}">
                    你好,<a>${sessionScope.user.nickname}</a>
                </c:if>
            </p>
        ...
        <ul class="clearfix" id="bott">
            <li><a href="${pageContext.request.contextPath}/jsp/IndexServlet?action=base">首页</a></li>
